...
public class ModeloBuscador {
	...
	private Busqueda busqueda = new Busqueda(null, null, null, null);
	...
	public void search() {
		validar();
		ArrayList<Asiento> asientos = buscador.buscarAsientos(this.busqueda,
				this.usuario);
		this.busqueda.setResultado(asientos);
		buscador.mostrarAsientos(busqueda.getResultado(),
	...
	private boolean cumpleFormatoFecha() {
		return this.busqueda.getFechaV().esFormatoLatinoamericano(
				this.busqueda.getFechaV().getFechaS());
	}
